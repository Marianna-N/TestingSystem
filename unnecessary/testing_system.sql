...
--
-- Хост: localhost
-- Время создания: Июл 07 2017 г., 00:17
...
CREATE TABLE `guest` (
  ...
  `g_key` char(10) NOT NULL COMMENT 'Key, which allow to pass the test.',
...
(6, 'msg_error_permissions', 'Login name doesn\'t exit!');
...
(2, 'admin2', '1c6637a8f2e1f75e06ff9984894d6bd16a3a36a9', 'Svyatoslav', 'Kulikov', 'admin', 'svyatoslav_kulikov@epam.com', NULL, 1),
...
CREATE TABLE `user_statistics` (
  ...
  `us_percent` int(10) UNSIGNED NOT NULL COMMENT 'Percent, with which user passed the test.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `answer`
  MODIFY `a_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=106;
--
-- AUTO_INCREMENT для таблицы `assigned_tests`
--
ALTER TABLE `assigned_tests`
  MODIFY `at_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key', AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `formed_test`
--
ALTER TABLE `formed_test`
  MODIFY `f_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key', AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT для таблицы `guest`
--
ALTER TABLE `guest`
  MODIFY `g_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
...
--
ALTER TABLE `message`
  MODIFY `m_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key', AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT для таблицы `picture`
--
ALTER TABLE `picture`
  MODIFY `p_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT для таблицы `question`
--
ALTER TABLE `question`
  MODIFY `q_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Question''s primary key', AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT для таблицы `test`
--
ALTER TABLE `test`
  MODIFY `t_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key', AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT для таблицы `user`
--
ALTER TABLE `user`
  MODIFY `u_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT для таблицы `user_statistics`
--
ALTER TABLE `user_statistics`
  MODIFY `us_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key';
--
